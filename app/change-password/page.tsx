        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200 border border-slate-100 p-8 sm:p-12">
            <header className="text-center mb-10">
              <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-sm transition-all duration-700 ${success ? 'bg-emerald-100 text-emerald-600 scale-110' : 'bg-blue-50 text-blue-600'}`}>
                {success ? (
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 animate-in zoom-in duration-500">
              ...
              <h1 className="text-2xl font-black text-slate-900 tracking-tight">
                {success ? "Password Updated!" : "Security Update"}
              </h1>
              <p className="text-slate-500 text-sm mt-2 font-medium">
                {success ? "You're all set. Redirecting to login..." : "Please set a new password to continue."}
              </p>
            </header>
            ...
            {!success && (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="relative">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-6 py-4 bg-slate-50 border-none rounded-2xl text-slate-900 placeholder:text-slate-300 focus:ring-2 focus:ring-blue-500 transition-all font-medium pr-14"
                    />
                    <button
                      type="button"
                ...
                >
                  {isLoading ? "Updating Security..." : "Save & Continue"}
                </button>
              </form>
            )}
          </div>
